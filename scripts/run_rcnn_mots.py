...
def plot_image_boxes(image, boxes):
...
if __name__ == "__main__":
    ...
    frames_path = Path("/home/vy/university/thesis/datasets/MOTS/train")
    output_path = Path("/home/vy/university/thesis/datasets/MOTS/train")
    ...
    for seq in sorted(frames_path.glob("*")):
        ...
        for i, img_path in enumerate(sorted((seq / "img1").glob("*"))):
