""" Prepares gt files for evaluation with TrackEval
...
def main(ann_path, output_path, split_name, bench_name):
    ...
    for seq in train_seqs:
        ...
        copy_tree(
            str(ann_path / "all" / seq / "gt"), str(output_path_train / seq / "gt")
        )
        copyfile(
            str(ann_path / "all" / seq / "seqinfo.ini"),
    ...
    for seq in test_seqs:
        ...
        copy_tree(
            str(ann_path / "all" / seq / "gt"), str(output_path_test / seq / "gt")
        )
        copyfile(
            str(ann_path / "all" / seq / "seqinfo.ini"),
